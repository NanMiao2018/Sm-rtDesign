...
//    }
    ...
    public static String getSuccessGetsCode() {
        return SUCCESS_GETS_CODE;
    }

    public static void setSuccessGetsCode(String successGetsCode) {
        SUCCESS_GETS_CODE = successGetsCode;
    }
